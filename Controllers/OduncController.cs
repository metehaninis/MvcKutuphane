...
namespace MvcKutuphane.Controllers
{
    ...
    public class OduncController : Controller
    {
        ...
        {
            //yukarıda yaptıgımız dropdownistler her seferinde hata verir ancak boş olarak ad kitapvs ekleme yapar bunu düzelttik
        ...
        public ActionResult Odunciade(TBLHAREKET p)
        {
            ...
            DateTime d1 = DateTime.Parse(odn.IADETARIH.ToString());         //geçmiş iade tarihleri 
            DateTime d2 = Convert.ToDateTime(DateTime.Now.ToShortDateString());
            TimeSpan d3 = d2 - d1;                                             //iki tarih arasındaki farkı almak için
