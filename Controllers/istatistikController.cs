...
namespace MvcKutuphane.Controllers
{
    public class istatistikController : Controller
    {
        ...
        [HttpPost]
        public ActionResult ResimYukle(HttpPostedFileBase dosya)   //burdaki parametre ile view deki inputun name ve id adı aynı olmalı
        {
            if (dosya.ContentLength > 0)  //dosyanın içeriğinin boyutu büyükse 0 dan 
            {
        ...
        public ActionResult LinqKart()
        {
            ...
            var deger12 = db.TBLHAREKET.Where(x => x.IADETARIH == DateTime.Now).Count();
            ViewBag.dgr1 = deger1;
            ViewBag.dgr2 = deger2;
            ViewBag.dgr3 = deger3;
            ViewBag.dgr4 = deger4;
